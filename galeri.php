...
<head>
    ...
    <title>Galeri - Kajian Islam Sistem Informasi ITS</title>
...
<body id="page-top" class="index">
	...
	<table>
		...
		?>
			<td>
				<a href="foto_file/<?php echo $row['gambar'];?>">
				<img src="foto_file/<?php echo $row['gambar'];?>" alt="" width='200' height='200'/>
				</a>
				<div>
               
              </div>
                <br/><center><h4><?php echo $row['judul'];?></h4></center>	
		  </td>
		<?php
			if($i % 3 == 0){
				echo '</tr><tr>';
