...
<body id="page-top" class="index">
              ...
              <div class="col-sm-4 portfolio-item">
                <a href="#portfolioModal11" class="portfolio-link" data-toggle="modal">
                  <div class="caption">
                      ...
                      <img src="img/portfolio/sejarah.png" class="img-responsive" alt="">
                  </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal12" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/visi.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                  <a href="#portfolioModal13" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/struk.png" class="img-responsive" alt="">
                    </a>
                </div>
    ...
    <footer class="text-center">
       ...
       target="_blank"><img src="img/JMMI.png" style="float:center; width:120px; height:120px"/></div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Halaman ini akan diupdate sesegera mungkin.</p>
